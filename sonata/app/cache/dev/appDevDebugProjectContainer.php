...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'cms_demo', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0dab1c499e1979f8a17e890a7beabfc8664f2107a774780a1c8d7109f83f62ae');
    ...
    protected function getSimplethingsEntityaudit_ConfigService()
    {
        ...
        $instance->setAuditedEntityClasses(array(0 => 'Application\\Sonata\\UserBundle\\Entity\\User', 1 => 'Application\\Sonata\\UserBundle\\Entity\\Group', 2 => 'Application\\Sonata\\NotificationBundle\\Entity\\Message'));
    ...
    protected function getSonata_Admin_Audit_ManagerService()
    {
        ...
        $instance->setReader('sonata.admin.audit.orm.reader', array(0 => 'Application\\Sonata\\UserBundle\\Entity\\User', 1 => 'Application\\Sonata\\UserBundle\\Entity\\Group', 2 => 'Application\\Sonata\\NotificationBundle\\Entity\\Message'));
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'sonata.notification.admin.message'));
        $instance->setAdminGroups(array('sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group')), 'sonata_notification' => array('label' => 'sonata_notification', 'label_catalogue' => 'SonataNotificationBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.notification.admin.message'))));
        $instance->setAdminClasses(array('Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group'), 'Application\\Sonata\\NotificationBundle\\Entity\\Message' => array(0 => 'sonata.notification.admin.message')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'sonata.notification.admin.message'), $this);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('732da3bf3327ad59d5176df8cf4ae48bafb3c1fe');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => '732da3bf3327ad59d5176df8cf4ae48bafb3c1fe',
            ...
            'kernel.secret' => '732da3bf3327ad59d5176df8cf4ae48bafb3c1fe',
            ...
            'assetic.ruby.bin' => ($this->targetDirs[5].'/.rvm/rubies/ruby-2.1.1/bin/ruby'),
            ...
            'simplethings.entityaudit.audited_entities' => array(
                ...
                2 => 'Application\\Sonata\\NotificationBundle\\Entity\\Message',
            ),
